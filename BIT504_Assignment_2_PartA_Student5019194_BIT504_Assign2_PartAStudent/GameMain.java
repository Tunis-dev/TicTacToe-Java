...
public class GameMain extends JPanel implements MouseListener{
	...
	//Constants for game 
	public static final int ROWS = 3; // number of ROWS by COLS cell constants   
	public static final int COLS = 3;  //object
	  ...
	  //** Initialize the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) { // check for win
				...
				// TODO: check which player has won and update the current state to the appropriate gamestate for the winner
	...
	public void mouseClicked(MouseEvent e) {  
		...
		repaint();//TODO: redraw the graphics on the UI          
